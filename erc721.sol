...
contract SupplyToken is ERC721PresetMinterPauserAutoId {
    ...
    constructor() ERC721PresetMinterPauserAutoId("SupplyToken ", "ST", "url") {}

    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override {
        require(tokenLockedFromTimestamp[tokenId] > block.timestamp || tokenUnlocked[tokenId], "SupplyToken Token locked");
    ...
    function unlockToken(bytes32 unlockHash, uint256 tokenId) public {
        ...
        require(keccak256(abi.encode(unlockHash)) == tokenUnlockCodeHashes[tokenId], "SupplyToken: Unlock Code Incorrect");
